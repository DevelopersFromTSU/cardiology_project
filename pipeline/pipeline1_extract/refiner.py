...
def refine_medical_chunk(chunk_text, max_retries=3):
    ...
    sys_instr = (
        ...
        "2. ПРЕОБРАЗОВАНИЕ ТАБЛИЦ И СПИСКОВ: Если в тексте есть Markdown-таблицы (|---|), ПЕРЕПИШИ их в виде развернутых, "
        ...
        "Если перед тобой медицинский перечень или маркированный список симптомов/факторов риска, ОБЯЗАТЕЛЬНО преобразуй каждый "
        "пункт в самостоятельное предложение или в атомарную структуру 'Условия: [...] => Значение: ...', чтобы текст не шел "
        "сплошным неструктурированным полотном.\n"
