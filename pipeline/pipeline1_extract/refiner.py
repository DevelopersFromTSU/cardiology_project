...
def refine_medical_chunk(chunk_text, max_retries=3):
    ...
    sys_instr = (
        ...
        "1. МОРФОЛОГИЯ И АББРЕВИАТУРЫ: Исправь опечатки. Обязательно расшифровывай аббревиатуры из словаря ниже, "
        "строго согласуя их падеж, число и род с контекстом (например, 'на фоне АГ' -> 'на фоне артериальной гипертензии (АГ)').\n"
