...
def refine_medical_chunk(chunk_text, max_retries=3):
    ...
    sys_instr = (
        ...
        "2. ИСПРАВЛЕНИЕ ЛОЖНЫХ РАСШИФРОВОК: Устраняй нелепые и сломанные расшифровки аббревиатур. Если сокращение расшифровано абсурдно или не по контексту (например, когда 'ЕОК' или 'EОК' ошибочно раскрыто как 'оральные контрацептивы' рядом с 'ЕОАГ' или классами рекомендаций I/II/III), восстанови правильный термин ('Европейское общество кардиологов' или 'ЕОК/ЕОАГ').\n"
        "3. ЧИСТОТА ФОРМАТИРОВАНИЯ: Не выводи строковые литералы '\\\\n\\\\n' как сырой текст — делай настоящие переносы строк между абзацами. Склеивай разорванные внутри предложений слова и предлоги.\n"
