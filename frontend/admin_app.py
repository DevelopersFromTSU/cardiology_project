...
# ИМПОРТИРУЕМ ФУНКЦИЮ ИЗ НАШЕГО НОВОГО СЕРВИСА
from pipeline.pipeline1_extract.smart_reparse_service import run_smart_reparse
...
# ... (и дальше идет класс StreamlitConsole и остальной код интерфейса) ...
